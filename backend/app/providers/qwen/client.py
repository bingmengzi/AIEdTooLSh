...
from app.providers.qwen.config import QWEN_CONFIG
from app.config import settings

logger = logging.getLogger(__name__)

class QwenClient(AIProvider):
    def __init__(self):
        self.name = QWEN_CONFIG["name"]
        self.model = QWEN_CONFIG["model"]
        self.api_base = QWEN_CONFIG["api_base"]
        self.priority = QWEN_CONFIG["priority"]
    ...
    async def chat_stream(
        ...
        max_tokens = max_tokens or QWEN_CONFIG["max_tokens"]
